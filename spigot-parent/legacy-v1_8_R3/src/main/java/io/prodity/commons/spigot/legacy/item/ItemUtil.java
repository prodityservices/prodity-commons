...
public class ItemUtil {
    ...
    public static void setSkullOwnerIfSkull(ItemStack itemStack, String ownerName) {
    ...
    public static void setSkullOwnerIfSkull(ItemStack itemStack, Supplier<OfflinePlayer> ownerSupplier) {
        final ItemMeta meta = itemStack.getItemMeta();
        if (meta instanceof SkullMeta) {
            ((SkullMeta) meta).setOwner(ownerSupplier.get().getName());
            itemStack.setItemMeta(meta);
        }
    }
    ...
    public static ItemStack toCraftItem(ItemStack item) {
        return ItemUtil.getProvider().toCraftItemStack(item);
    }
