package io.prodity.commons.spigot.legacy.particle;

import io.prodity.commons.spigot.legacy.particle.util.ParticleReflectUtil;
import io.prodity.commons.spigot.legacy.particle.util.ParticleReflectUtil.PackageType;
...
public enum Particle {
    ...
    private static final Map<String, Particle> NAME_MAP = new HashMap<>();
    private static final Map<Integer, Particle> ID_MAP = new HashMap<>();
     ...
     * @see ParticlePacket#ParticlePacket(Particle, Vector, float, boolean, ParticleData)
     * @see ParticlePacket#sendTo(Location, double)
     */
     ...
     * @see ParticlePacket#ParticlePacket(Particle, ParticleColor, boolean)
     * @see ParticlePacket#sendTo(Location, double)
     */
     ...
     * <p>
     * This class is part of the <b>Particle Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
     * @since 1.7
     */
    ...
    /**
     * Represents the particle data for effects like {@link Particle#ITEM_CRACK}, {@link Particle#BLOCK_CRACK} and {@link Particle#BLOCK_DUST}
     * <p>
     * This class is part of the <b>Particle Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the block data for the {@link Particle#BLOCK_CRACK} and {@link Particle#BLOCK_DUST} effects
     * <p>
     * This class is part of the <b>Particle Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the color for effects like {@link Particle#SPELL_MOB}, {@link Particle#SPELL_MOB_AMBIENT}, {@link Particle#REDSTONE} and {@link Particle#NOTE}
     * <p>
     * This class is part of the <b>Particle Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the color for effects like {@link Particle#SPELL_MOB}, {@link Particle#SPELL_MOB_AMBIENT} and {@link Particle#NOTE}
     * <p>
     * This class is part of the <b>Particle Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static final class ParticlePacket {
         ...
         * @see #initialize()
         */
        public ParticlePacket(Particle effect, float offsetX, float offsetY, float offsetZ, float speed,
         ...
         * @see #ParticleEffect(Particle, float, float, float, float, int, boolean, ParticleData)
         */
        public ParticlePacket(Particle effect, Vector direction, float speed, boolean longDistance,
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                packetConstructor = ParticleReflectUtil.getConstructor(packetClass);
                getHandle = ParticleReflectUtil.getMethod("CraftPlayer", PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
                playerConnection = ParticleReflectUtil.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
                sendPacket = ParticleReflectUtil
        ...
        private void initializePacket(Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    ParticleReflectUtil.setValue(this.packet, true, "a", name);
                } else {
                    ParticleReflectUtil.setValue(this.packet, true, "a", enumParticle.getEnumConstants()[this.effect.getId()]);
                    ParticleReflectUtil.setValue(this.packet, true, "j", this.longDistance);
                    if (this.data != null) {
                        int[] packetData = this.data.getPacketData();
                        ParticleReflectUtil.setValue(this.packet, true, "k",
                            this.effect == Particle.ITEM_CRACK ? packetData
                                : new int[]{packetData[0] | (packetData[1] << 12)});
                    }
                }
                ParticleReflectUtil.setValue(this.packet, true, "b", (float) center.getX());
                ParticleReflectUtil.setValue(this.packet, true, "c", (float) center.getY());
                ParticleReflectUtil.setValue(this.packet, true, "d", (float) center.getZ());
                ParticleReflectUtil.setValue(this.packet, true, "e", this.offsetX);
                ParticleReflectUtil.setValue(this.packet, true, "f", this.offsetY);
                ParticleReflectUtil.setValue(this.packet, true, "g", this.offsetZ);
                ParticleReflectUtil.setValue(this.packet, true, "h", this.speed);
                ParticleReflectUtil.setValue(this.packet, true, "i", this.amount);
            } catch (Exception exception) {
