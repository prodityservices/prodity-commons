package io.prodity.commons.spigot.effect.sound;

import com.google.common.base.Preconditions;
import com.google.common.collect.ImmutableSet;
import io.prodity.commons.lazy.Lazy;
import io.prodity.commons.lazy.SimpleLazy;
import io.prodity.commons.spigot.inject.McVersions;
import io.prodity.commons.spigot.inject.impl.McVersionFeature;
import org.bukkit.Sound;

/**
 * Wrappers for Bukkit's {@link Sound} constants which change across minecraft vesions.
 */
public enum SoundWrapper {
    ...
    private static final ImmutableSet<String> PRE_19_VERSIONS = ImmutableSet.<String>builder()
        .add(McVersions.V1_8_R1)
        .add(McVersions.V1_8_R2)
        .add(McVersions.V1_8_R3)
        .build();

    private final String pre19Name;
    private final String post19Name;
    private final Lazy<Sound> soundLazy = new SimpleLazy<>(this::resolveSound);

    SoundWrapper(String pre19Name, String post19Name) {
        Preconditions.checkNotNull(pre19Name, "pre19Name");
        Preconditions.checkNotNull(post19Name, "post19Name");
        this.pre19Name = pre19Name;
        this.post19Name = post19Name;
    }

    public String getPre19Name() {
        return this.pre19Name;
    }

    public String getPost19Name() {
        return this.post19Name;
    }

    private Sound resolveSound() {
        final String soundName;
        if (SoundWrapper.PRE_19_VERSIONS.contains(McVersionFeature.CURRENT)) {
            soundName = this.pre19Name;
        } else {
            soundName = this.post19Name;
        }
        return Sound.valueOf(soundName);
    }

    public Sound toSound() {
        return this.soundLazy.get();
    }
