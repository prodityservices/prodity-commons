...
CREATE VIEW `name_last_seen` (player_name, player_last_seen) AS
  SELECT player_name, MAX(player_last_seen) AS player_last_seen FROM name_cache GROUP BY player_name;
CREATE VIEW `names`(player_id, player_name, player_last_seen) AS
  SELECT player_id, player_name, player_last_seen FROM name_cache
