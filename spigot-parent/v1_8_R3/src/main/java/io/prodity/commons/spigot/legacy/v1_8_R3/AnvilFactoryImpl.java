package io.prodity.commons.spigot.legacy.v1_8_R3;
...
@Service
@Export
@McVersion(ProdityVersions.V1_8)
    ...
    private class Handler extends ChannelDuplexHandler {
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
            if (msg instanceof PacketPlayInCustomPayload) {
                ...
                if (packet.a().equals("MC|ItemName")) {
        ...
        private boolean handlePacket(PacketPlayInCustomPayload msg) {
            ...
            if ((msg.b() != null) && (msg.b().readableBytes() >= 1)) {
                value = this.filterInput(msg.b().c(Short.MAX_VALUE));
                if (value.length() > 30) {
