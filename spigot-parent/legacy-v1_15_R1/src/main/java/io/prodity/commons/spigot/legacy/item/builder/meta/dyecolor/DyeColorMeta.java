...
public abstract class DyeColorMeta extends AbstractItemBuilderMeta<DyeColor> {
    ...
    public static final ImmutableMap<Material, Pair<Function<DyeColor, Byte>, Function<Byte, DyeColor>>> TYPES =
        ImmutableMap.<Material, Pair<Function<DyeColor, Byte>, Function<Byte, DyeColor>>>builder()
            //Wool
            .put(Material.WHITE_WOOL, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            .put(Material.TERRACOTTA, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            .put(Material.GLASS, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            .put(Material.GLASS_PANE, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            .put(Material.WHITE_CONCRETE, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            .put(Material.WHITE_CONCRETE_POWDER, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            .put(Material.WHITE_BED, ImmutablePair.create(DyeColor::getWoolData, DyeColor::getByWoolData))
            //Dye
            .put(Material.INK_SAC, ImmutablePair.create(DyeColor::getDyeData, DyeColor::getByDyeData))
            .put(Material.WHITE_BANNER, ImmutablePair.create(DyeColor::getDyeData, DyeColor::getByDyeData))
            .build();
