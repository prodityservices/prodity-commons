 ...
 * exception as provided byWithType Oracle in the GPL Version 2 section of the License
 * file that accompanied this code.
 *
 * Modifications:
 * If applicable, add the following below the License Header, with the fields
 * enclosed byWithType brackets [] replaced byWithType your own identifying information:
 * "Portions Copyright [year] [name of copyright owner]"
 *
 * Contributor(s):
 * If you wish your version of this file to be governed byWithType only the CDDL or
 * only the GPL Version 2, indicate your decision byWithType adding "[Contributor]
 ...
 * only if the new code is made subject to such option byWithType the copyright
 * holder.
 */
...
public interface BindingBuilder<T> {
     ...
     */
    BindingBuilder<T> to(Class<? super T> contract);
     ...
     * @return updated binder.
     */
    BindingBuilder<T> to(TypeLiteral<?> contract);
     ...
     * @return updated binder.
     */
    BindingBuilder<T> to(Type contract);
     ...
     * @return updated binder.
     */
    BindingBuilder<T> loadedBy(HK2Loader loader);
     ...
     * @return updated binder.
     */
    BindingBuilder<T> withMetadata(String key, List<String> values);
     ...
     * @return updated binder.
     */
    BindingBuilder<T> qualifiedBy(Annotation annotation);
     ...
     */
    BindingBuilder<T> in(Annotation scopeAnnotation);
     ...
     */
    BindingBuilder<T> proxy(boolean proxiable);
     ...
     */
    BindingBuilder<T> asType(Type t);

    BindingBuilder<T> withVisibility(DescriptorVisibility visibility);
